...
```
# 初始化节点
rs.initiate({ _id: "csrs",version: 1,members: [{ _id: 0, host : "172.20.0.11:27019" }]});
# 添加节点
rs.add("172.20.0.12:27019");
```
...
#### 分片3
s31：172.20.0.18:27018
s32：172.20.0.19:27018
...
#### 分片4
s31：172.20.0.20:27018
s32：172.20.0.21:27018
...
sh.addShard("shrs03/172.20.0.18:27018,172.20.0.19:27018");
sh.addShard("shrs04/172.20.0.20:27018,172.20.0.21:27018");
```
